...
### 前端框架
- **Next.js 15.5.4** - React 全栈框架，App Router 架构
...
### MDX 内容管理
- **@next/mdx 15.5.4** - Next.js 原生 MDX 支持
...
- **Zod 4.1.5** - TypeScript 模式验证和数据校验
...
- **eslint-config-next 15.5.2** - Next.js ESLint 配置预设
...
### 构建工具
- **@next/bundle-analyzer 15.5.2** - 包大小分析
...
- **happy-dom 18.0.1** - 轻量级 DOM 环境（性能优化）
...
- **@axe-core/playwright 4.11.0** - 无障碍测试集成
- **axe-core 4.11.0** - 无障碍测试核心
