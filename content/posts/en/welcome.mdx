---
locale: 'en'
title: 'Welcome to B2B Web Template'
description:
...
seo:
  title: 'Welcome to B2B Web Template - Modern Enterprise Web Template'
  description:
...
# Welcome to B2B Web Template

We're excited to introduce **B2B Web Template**, a cutting-edge
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/Alx-707/b2b-web-template
   cd B2B Web Template
   ```
...
[Get started with B2B Web Template](https://github.com/Alx-707/b2b-web-template)
