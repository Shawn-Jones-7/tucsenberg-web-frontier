...
import { ANIMATION_DURATION_VERY_SLOW, BYTES_PER_KB, COUNT_FIVE, COUNT_TEN, COUNT_TRIPLE, DAYS_PER_MONTH, DAYS_PER_WEEK, HOURS_PER_DAY, MAGIC_6, ONE, PERCENTAGE_HALF, SECONDS_PER_MINUTE, THIRTY_SECONDS_MS, ZERO } from "@/constants/magic-numbers";
