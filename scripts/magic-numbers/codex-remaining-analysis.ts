...
interface RemainingNumber {
  value: string;
  files: string[];
  category: 'eslint_exempt' | 'units_lib' | 'config' | 'local_const' | 'keep_magic';
  reason: string;
  action: string;
}
...
const remainingNumbers = [
  // 基础计数和小数字
  { value: '4', files: ['src/constants/dev-tools.ts', 'src/constants/test-app-constants.ts'] },
  { value: '6', files: ['src/lib/accessibility-utils.ts', 'src/components/forms/fields/additional-fields.tsx'] },
  { value: '7', files: ['src/constants/security-constants.ts', 'src/lib/colors/utils.ts'] },
  { value: '8', files: ['src/constants/dev-tools.ts', 'src/constants/security-constants.ts'] },
  { value: '9', files: ['src/constants/performance-constants.ts', 'src/lib/locale-storage-analytics-performance.ts'] },
  
  // 时间相关（毫秒）
  { value: '2000', files: ['src/components/language-toggle.tsx', 'src/components/i18n/translation-preloader.tsx'] },
  { value: '4000', files: ['src/constants/performance-constants.ts', 'src/hooks/use-toast.ts'] },
  ...
  { value: '12000', files: ['src/lib/i18n-preloader-strategies/configs.ts', 'src/app/api/analytics/i18n/route.ts'] },
  ...
  { value: '100000', files: ['src/constants/dev-tools.ts', 'src/constants/react-scan.ts'] },
  { value: '120000', files: ['src/constants/dev-tools.ts'] },
  { value: '125000', files: ['src/app/api/monitoring/dashboard/handlers/get-handler.ts'] },
  { value: '170000', files: ['src/constants/test-performance-constants.ts'] },
  { value: '200000', files: ['src/constants/app-constants.ts', 'src/lib/locale-storage-types-config/presets.ts'] },
  { value: '300000', files: ['src/constants/app-constants.ts', 'src/lib/locale-storage-types-config/presets.ts'] },
  ...
  // 尺寸和像素
  { value: '16', files: ['src/hooks/performance-monitor-utils.ts', 'src/components/ui/animated-counter-helpers.tsx'] },
  { value: '20', files: ['src/config/security.ts', 'src/constants/i18n-constants.ts'] },
  { value: '32', files: ['src/constants/security-constants.ts', 'src/lib/i18n-lru-cache.ts'] },
  { value: '64', files: ['src/constants/react-scan.ts', 'src/lib/locale-storage-types-config/validation.ts'] },
  { value: '80', files: ['src/config/security.ts', 'src/constants/i18n-constants.ts'] },
  { value: '120', files: ['src/components/layout/logo.tsx', 'src/app/api/analytics/i18n/route.ts'] },
  { value: '128', files: ['src/constants/security-constants.ts'] },
  { value: '150', files: ['src/constants/performance-constants.ts', 'src/app/api/analytics/i18n/route.ts'] },
  { value: '160', files: ['src/config/security.ts', 'src/lib/content-utils.ts'] },
  { value: '190', files: ['src/types/whatsapp-api-config/errors.ts'] },
  { value: '250', files: ['src/constants/test-constants.ts', 'src/lib/navigation.ts'] },
  { value: '256', files: ['src/constants/security-constants.ts', 'src/lib/i18n-cache-types-advanced.ts'] },
  { value: '512', files: ['src/lib/performance-monitoring-constants.ts', 'src/lib/i18n-cache-types-advanced.ts'] },
  { value: '600', files: ['src/constants/test-performance-constants.ts', 'src/lib/i18n-preloader-strategies/configs.ts'] },
  { value: '700', files: ['src/lib/site-config.ts', 'src/components/home/call-to-action.tsx'] },
  { value: '750', files: ['src/constants/test-performance-constants.ts'] },
  { value: '800', files: ['src/constants/performance-constants.ts', 'src/lib/enhanced-web-vitals.ts'] },
  { value: '1200', files: ['src/constants/app-constants.ts', 'src/hooks/web-vitals-diagnostics-calculator.ts'] },
  { value: '1536', files: ['src/hooks/use-breakpoint.ts'] },
  { value: '1600', files: ['src/app/[locale]/layout.tsx'] },
  { value: '1800', files: ['src/constants/performance-constants.ts', 'src/lib/enhanced-web-vitals.ts'] },
  
  // 数据大小（字节）
  { value: '2048', files: ['src/constants/security-constants.ts', 'src/constants/test-performance-constants.ts'] },
  { value: '4096', files: ['src/lib/locale-storage-cookie.ts', 'src/lib/whatsapp-utils.ts'] },
  { value: '8192', files: ['src/constants/test-performance-constants.ts'] },
  { value: '65536', files: ['src/constants/test-web-vitals-constants.ts'] },
  
  // 百分比和比例
  { value: '12', files: ['src/constants/i18n-constants.ts', 'src/lib/translation-quality.ts'] },
  { value: '15', files: ['src/config/security.ts', 'src/lib/validations.ts'] },
  { value: '35', files: ['src/lib/i18n-metrics-collector.ts'] },
  { value: '40', files: ['src/lib/i18n-metrics-collector.ts', 'src/lib/performance-monitoring-constants.ts'] },
  { value: '45', files: ['src/app/api/analytics/i18n/route.ts', 'src/app/api/analytics/web-vitals/route.ts'] },
  { value: '65', files: ['src/app/api/analytics/web-vitals/route.ts'] },
  { value: '70', files: ['src/constants/i18n-constants.ts', 'src/lib/enhanced-web-vitals.ts'] },
  { value: '75', files: ['src/components/shared/animations/showcase-config.tsx'] },
  { value: '85', files: ['src/lib/translation-benchmarks.ts', 'src/app/api/analytics/web-vitals/route.ts'] },
  { value: '95', files: ['src/constants/i18n-constants.ts', 'src/components/i18n/translation-fallback.tsx'] },
  ...
  { value: '49', files: ['src/app/[locale]/diagnostics/page-utils.ts', 'src/app/[locale]/diagnostics/utils.ts'] },
  { value: '96', files: ['src/constants/test-ui-constants.ts'] },
  { value: '131', files: ['src/types/whatsapp-api-config/errors.ts'] },
  { value: '255', files: ['src/constants/security-constants.ts', 'src/constants/react-scan.ts'] },
 ...
 * 对单个剩余数字进行分类
 */
function categorizeRemainingNumber(value: string, files: string[]): RemainingNumber {
  ...
  // 2. 时间相关 - 单位工具库
  if ([2000, 4000, 6000, 7000, 8000, 9000, 12000, 15000, 45000, 50000, 100000, 120000, 125000, 170000, 200000, 300000, 500000].includes(num)) {
    return {
      value,
      files,
      category: 'units_lib',
  ...
  // 6. 百分比 - 单位工具库
  if (num <= 100 && files.some(f => f.includes('performance') || f.includes('analytics'))) {
    return {
      value,
      files,
      category: 'units_lib',
  ...
  // 7. 尺寸和像素 - 局部常量或单位工具库
  if ([16, 20, 32, 64, 80, 120, 128, 150, 160, 190, 250, 256, 512, 600, 700, 750, 800, 1200, 1536, 1600, 1800].includes(num)) {
    if (files.length === 1) {
      return {
        value,
        files,
